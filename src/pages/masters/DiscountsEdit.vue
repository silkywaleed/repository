...
//   },
    ...
    methods: {
        ...
        getHubData(hubId) {
            axios.get(`${import.meta.env.VITE_APP_API_URL}api/admin/hub/edit/${hubId}`, {
                headers: {
            ...
            .then(
                (res) => {
                    ...
                    this.user.name =  res.data.data.hub.name
                    this.user.email= res.data.data.hub.email
                    this.user.state= res.data.data.hub.state
                    this.user.zip_code= res.data.data.hub.zip_code
                    this.user.address= res.data.data.hub.address
                    this.user.city_id= res.data.data.hub.city_id
                    this.user.code= res.data.data.hub.code
                    this.user.phone= res.data.data.hub.phone
                    this.user.country_id= res.data.data.hub.country_id
                    this.user.is_active= res.data.data.hub.is_active
                    this.user.is_default= res.data.data.hub.is_default
                    this.user.cities= res.data.data.cities
                    this.user.countries= res.data.data.countries
                    this.user.hubs= res.data.data.hubs
                },
                (error) => {
    ...
    mounted() {
        this.getHubData(this.$route.params.id);
        // this.addSettings({
        //         headers: {
        //         'X-Tenant': localStorage.getItem('tenant_id'),
        //         'Authorization': `Bearer ${localStorage.getItem('token')}`
                        ...
                        <div class="md:w-full d-flex align-items-center h-auto">
                            <div class="container-fluid p-0 m-0">
                                        ...
                                        <div class="text-center">
                                            <div class="relative inline-flex self-center w-full">
                                                ...
                                                <select class="text-lg font-bold rounded border-2 border-[#b6b8bf] text-gray-600 h-10 w-full pl-5 pr-10 bg-[#D3D3D3] hover:border-gray-400 focus:outline-none appearance-none">
                                                    <option v-for="i in user.hubs" value="i">{{ i.name }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="md:w-2/4 w-full">
                                        ...
                                        <div class="text-center">
                                            <div class="relative inline-flex self-center w-full">
                                                ...
                                                <select class="text-lg font-bold rounded border-2 border-[#b6b8bf] text-gray-600 h-10 w-full pl-5 pr-10 bg-[#D3D3D3] hover:border-gray-400 focus:outline-none appearance-none">
                                                    <option v-for="i in user.countries" value="i">{{ i.name }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="md:w-2/4 w-full">
                                        ...
                                        <div class="text-center">
                                            <div class="relative inline-flex self-center w-full">
                                                ...
                                                <select class="text-lg font-bold rounded border-2 border-[#b6b8bf] text-gray-600 h-10 w-full pl-5 pr-10 bg-[#D3D3D3] hover:border-gray-400 focus:outline-none appearance-none">
                                                    <option v-for="i in user.cities" value="i">{{ i.name }}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group flex justify-end text-center">
                                    <button id="kt_login_signin_submit" type="submit" class="btn btn-primary btn-primary-login height-42 font-weight-bold py-2 px-16 my-3">Edit</button>
                                </div>
                            </div>
                        </div>
                    </div>
