                                ...
                                <div class="flex flex-col text-center justify-center w-100">
                                    <img src="https://res.cloudinary.com/dlh4c743j/image/upload/v1692623935/Forgot_password-cuate_1_1_1_f0omyp.webp" alt="Logo" class="w-80 self-center"/>
                                        ...
                                        <span class="text-preresponsive px-1 py-6">
                                            We will send A pin code to reset your password
                                        </span>
                                </div>
                                <div class="form-group mt-3 mb-6">
                                    <span>Email <span class="text-red-400">*</span></span>
                                    <input class="form-control height-42 py-5" v-model="admin_email" placeholder="eg. email@gmail.com" type="email" name="email" id="email" autofocus autocomplete="off" />
                                    <span class="text-sm text-red-400" v-if="v$.admin_email.$error"> {{ v$.admin_email.$errors[0].$message }}</span>
                                </div>

                                <div class="form-group text-center">
                                    <button type="submit" class="btn btn-primary btn-primary-login height-42 btn-block font-weight-bold mb-3">Send</button>
                                </div>
                            </div>
                        </div>
                    </div>
