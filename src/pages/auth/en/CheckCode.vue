                        ...
                        <div class="w-4/6 d-flex align-items-center h-auto" style="max-width: 500px;">
                            <div class="container-fluid py-8 px-14 bg-white">
                                <div class="flex flex-col text-center justify-center w-100">
                                    ...
                                    <h2 class="text-primary text-responsive">
                                        ...
                                        <span class="text-preresponsive px-1 py-6">
                                            we Sent Verification Code to reset your password
                                        </span>
                                </div>
                                <div class="form-group mt-3 mb-6">
                                    <span>Enter PIN Code <span class="text-red-400">*</span></span>
                                ...
                                <div class="form-group mt-3 text-center">
                                    <button type="submit" class="btn btn-primary btn-primary-login height-42 btn-block font-weight-bold mb-3">Confirm</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    watch: {
        checkCodeResponse(data) {
            if(data.status == 200) {
                ...
                this.$router.push('/en-updatePassword');
